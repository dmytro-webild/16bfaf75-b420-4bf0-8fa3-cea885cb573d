...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      mediaItems={[
        ...
        {
          imageSrc: "http://img.b2bpic.net/free-photo/cheddar-cheese-slices-white-desk-with-bowls_23-2148166524.jpg",
          imageAlt: "زبدة بلدية",
        },
        {
          imageSrc: "http://img.b2bpic.net/free-photo/homemade-thin-fresh-crepes-with-strawberry-jam_114579-44078.jpg",
          imageAlt: "لبن رائب طازج",
        },
        {
          imageSrc: "http://img.b2bpic.net/free-photo/high-angle-jars-with-copy-space_23-2148563166.jpg",
          imageAlt: "مربيات منزلية",
        },
      ]}
    />
  </div>
  ...
  <div id="about" data-section="about">
      ...
      description={[
        "نحن في ألبان السيد كامل نؤمن بالجودة والأصالة. يقع محلنا في الحلة، حي نادر، متخصصون في تحضير مشتقات الحليب الجاموس والبقر يومياً.",
        "نتميز بقيمر العرب الملفوف الذي يعد رمزاً للضيافة، بالإضافة إلى تشكيلة واسعة من الأجبان، والدهن الحر، والمربيات، كل ذلك ننتجه بحب وعناية لنصل إلى مائدتكم طازجاً.",
      ]}
    />
  </div>
      ...
      products={[
        {
          ...
          brand: "السيد كامل",
          name: "قيمر عرب ملفوف",
          price: "20,000 د.ع / كغم",
          rating: 5,
          reviewCount: "120",
          imageSrc: "http://img.b2bpic.net/free-photo/view-delicious-dairy-products_23-2148601795.jpg",
        },
        {
          id: "p2",
          brand: "السيد كامل",
          ...
          rating: 5,
          reviewCount: "85",
          imageSrc: "http://img.b2bpic.net/free-photo/sliced-fresh-white-cheese-from-cows-milk-isolated-white-background_123827-29333.jpg",
        },
        {
          id: "p3",
          brand: "السيد كامل",
          name: "دهن حر أصلي",
          price: "16,000 د.ع / كغم",
          rating: 5,
          reviewCount: "92",
          imageSrc: "http://img.b2bpic.net/free-photo/closeu-up-side-view-delicious-soup-with-chicken-potato-spoon-dark-table-gray_140725-56813.jpg",
        },
        {
          id: "p4",
          brand: "السيد كامل",
          ...
          rating: 4,
          reviewCount: "45",
          imageSrc: "http://img.b2bpic.net/free-photo/ayran-drink-with-mint-cucumber-glass-blue-wooden-table_123827-22328.jpg",
        },
        {
          id: "p5",
          brand: "السيد كامل",
          name: "حليب جاموس البطل",
          price: "3,000 د.ع",
          rating: 5,
          reviewCount: "110",
          imageSrc: "http://img.b2bpic.net/free-photo/plant-garden-still-life_23-2148128728.jpg",
        },
        {
          id: "p6",
          brand: "السيد كامل",
          ...
          rating: 5,
          reviewCount: "55",
          imageSrc: "http://img.b2bpic.net/free-photo/high-angle-jars-with-jam_23-2148563165.jpg",
        },
      ]}
  ...
  <div id="features" data-section="features">
      ...
      features={[
        {
          title: "طازجة يومياً",
          description: "منتجاتنا تحضر بشكل يومي لضمان الطعم الطبيعي.",
          icon: Clock,
          mediaItems: [
            {
        ...
        {
          title: "حليب طبيعي",
          description: "استخدام حليب الجاموس والبقر من مزارع مختارة.",
          icon: ShieldCheck,
          mediaItems: [
            {
              imageSrc: "http://img.b2bpic.net/free-photo/close-up-view-bucket-milking-cows-animal-barn_1150-12778.jpg",
            },
            {
        ...
        {
          title: "توصيل سريع",
          description: "توصيل إلى كافة مناطق الحلة ومحافظة بابل.",
          icon: Truck,
          mediaItems: [
            {
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      testimonials={[
        ...
        },
        {
          ...
          company: "بابل",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/waist-up-portrait-beautiful-smiling-young-woman-with-positive-expression-wears-casual-black-t-shirt-has-tattooed-arm-models-against-concrete-wall_273609-3574.jpg",
        },
        {
          id: "t3",
          name: "عمر خالد",
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        {
          id: "f1",
          title: "هل التوصيل متوفر خارج الحلة؟",
          content: "نعم، التوصيل متوفر لجميع أنحاء محافظة بابل.",
        },
        {
          id: "f2",
          title: "هل المنتجات طازجة؟",
          content: "نعم، كافة الألبان والأجبان يتم تحضيرها بشكل يومي.",
        },
        {
          id: "f3",
          title: "كيف يمكن الطلب؟",
          content: "يمكنكم الاتصال عبر أرقامنا أو عبر الواتساب.",
        },
      ]}
      ...
      columns={[
        {
          ...
          items: [
            {
              label: "07806746136",
              href: "tel:07806746136",
            },
            {
              label: "07801338981",
              href: "tel:07801338981",
            },
          ],
        },
        {
